...
{
    public partial class sirketMusteriListele : Form
    {
        public sirketMusteriListele()
        {
            InitializeComponent();
        }
        ...
        private void sirketMusteriListele_Load(object sender, EventArgs e)
        {
            Kayit_Goster();
        ...
        private void txtSigortaAdi_TextChanged(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            MySqlDataAdapter adtr = new MySqlDataAdapter("select * from police where sirket_ismi like '%" + txtSigortaAdi.Text + "%'", baglanti);
            adtr.Fill(tablo);
